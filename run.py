...
def page_data_analysis():
    ...
    st.write("Based on the evaluation results, it was evident that the performance of the different regression models varies . the top ranked models were:")
    st.write("1.KNN had the highest ranking")
    st.write("2. LightGBM is second")
    st.write("the rest of the models are quite close to eachother and preformed rather ineffciently.")
...
def main():
    ...
    selected_page = st.sidebar.selectbox("Choose a page", ["Overview", "Data Analysis", "Test Our Model"])

    if selected_page == "Overview":
        page_overview()
    elif selected_page == "Data Analysis":
        page_data_analysis()
    elif selected_page == "Test Our Model":
        page_test_model()
